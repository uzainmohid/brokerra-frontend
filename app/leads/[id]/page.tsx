...
const DEMO_LEAD: LeadWithDetails = {
  ...
  propertyType: '3BHK Apartment',
  location: 'Bandra West, Mumbai',
  noteText: 'Interested in sea-facing unit. Needs parking.',
  ...
  return (
    <div className="flex items-start gap-3 py-3 border-b border-white/5 last:border-0">
      ...
      <div className="flex-1">
        <div className="text-[11px] text-white/30 uppercase">{label}</div>
        <div className="text-sm text-white/80">{value}</div>
      </div>
    </div>
  )
      ...
      <ScrollArea className="flex-1">
        <div className="p-6 space-y-6">
          ...
          <Tabs defaultValue="timeline">
            ...
            <TabsContent value="notes">
              <NotesSection leadId={id} notes={lead.notes} />
            </TabsContent>
          </Tabs>

          {/* AI Summary (kept safe) */}
          <AiSummaryCard leadId={id} existingSummary={lead.aiSummary} />
